...
$(document).ready(function () {
  ...
  $(".add-new").click(function () {
    ...
    var row = '<tr>' +
      '<td><input type="text" class="form-control" name="buildingID" id="buildingID"></td>' +
      '<td><input type="text" class="form-control" name="nameBuilding" id="nameBuildin"></td>' +
      '<td>' + actions + '</td>' +
      '</tr>';
    $("table").append(row);
    ...
    success: function (customer) {
      ...
      if (customer != "") {
        ...
        for (var i = 0; i < customer.length; i++) {
          var row = '<tr>' +
            '<td>' + customer[i].buildingID + '</td>' +
            '<td>' + customer[i].nameBuilding + '</td>' +
            '<td>' +
